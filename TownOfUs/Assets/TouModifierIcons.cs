...
public static class TouModifierIcons
{
    ...
    public static LoadableAsset<Sprite> Immovable { get; } = new LoadableBundleAsset<Sprite>("Immovable", TouAssets.MainBundle);
    ...
    public static LoadableAsset<Sprite> Satellite { get; } = new LoadableBundleAsset<Sprite>("Satellite", TouAssets.MainBundle);
